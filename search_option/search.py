...
from .search_pipe import search_pipe
...
async def search():
  ...
  if condition['d_flag'] == '1': result = Disparity_condition(result, condition['d_disparity_term'],condition['d_low_disparity'], condition['d_high_disparity']) # 이격도 비교
